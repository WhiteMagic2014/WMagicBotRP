...
import com.whitemagic2014.util.task.MagicOnceTask;
...
public class MagicMsgSender {
     ...
     **/
    public static void sendGroupMsg(Bot bot, Long groupId, Message msg) {
     ...
     **/
    public static String sendGroupMsgDelay(Bot bot, Long groupId, Message msg, Long delay) {
     ...
     * @Date: 2020/9/30 17:07
     **/
    public static String sendGroupMsgTiming(Bot bot, Long groupId, Message msg, Date time) {
        String key = MagicMd5.getMd5String("g" + groupId + msg.toString() + System.currentTimeMillis());
     ...
     **/
    public static void sendFriendMsg(Bot bot, Long uid, Message msg) {
     ...
     **/
    public static String sendFriendMsgDelay(Bot bot, Long uid, Message msg, Long delay) {
     ...
     * @Date: 2020/9/30 17:10
     **/
    public static String sendFriendMsgTiming(Bot bot, Long uid, Message msg, Date time) {
        String key = MagicMd5.getMd5String("u" + uid + msg.toString() + System.currentTimeMillis());
     ...
     * @Date: 2020/9/29 17:02
     **/
    public static void sendBroadcast(Bot bot, Message msg) {
