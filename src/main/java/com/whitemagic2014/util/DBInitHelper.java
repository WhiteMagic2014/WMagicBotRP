...
public class DBInitHelper {
    ...
    public static final String dbFileName = "WMagicBotRP.db";
    ...
    public boolean initDBIfNotExist() {
        File db = new File(com.whitemagic2014.util.Path.getPath() + dbFileName);
        if (db.exists()) {
            ...
            createDB();
            logger.info("已创建数据文件:" + com.whitemagic2014.util.Path.getPath() + dbFileName);
            return true;
        }
    }
